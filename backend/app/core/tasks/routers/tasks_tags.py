...
from aiutox_sdk.schemas import TaskResponse
from aiutox_sdk.tasks import get_task_tag_service
...
async def search_tasks(
    ...
    tasks = tag_service.search_tasks(  # type: ignore[attr-defined]
...
async def get_popular_tags(
    ...
    tags = tag_service.get_popular_tags(  # type: ignore[attr-defined]
        tenant_id=current_user.tenant_id,
        limit=limit,
    )
...
async def suggest_tags(
    ...
    suggestions = tag_service.suggest_tags(  # type: ignore[attr-defined]
        tenant_id=current_user.tenant_id,
        query=q,
        limit=limit,
    )
