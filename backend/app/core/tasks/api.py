...
from aiutox_sdk.schemas import TaskModuleSettings
from aiutox_sdk.tasks import TaskService
from fastapi import APIRouter, Depends
from sqlalchemy.orm import Session

# Import modular routers
from app.core.tasks.routers import (
    tasks_analytics,
    tasks_assignments,
    tasks_calendar,
    tasks_checklist,
...
router.include_router(tasks_time_tracking.router, tags=["tasks-time-tracking"])
