...
export const translations = {
  ...
  dashboard: {
    title: "Dashboard",
    description: "AiutoX ERP main panel",
    welcome: "Welcome",
    welcomeDescription: "System main panel",
    comingSoon: "Dashboard content will be implemented soon",
    noData: "No data available",
    errorLoading: "Error loading",
    configure: "Configure widgets",
    configureWidgets: "Configure widgets",
    resetDefaults: "Reset to defaults",
    openModule: "Open module",
    lastUpdated: "Updated",
    widgets: {
      realEstate: "Properties & Leases",
      realEstateDesc: "Occupancy, receivables & contracts",
      financial: "Finance & Billing",
      financialDesc: "P&L, cash flow & debtors",
      cmms: "Maintenance (CMMS)",
      cmmsDesc: "Work orders, MTTR & PM compliance",
    },
    quickActions: {
    ...
    realEstate: {
      ...
      agingTitle: "Overdue Receivables",
      ...
      totalInmuebles: "total properties",
    ...
    financial: {
      ...
      topMorososTitle: "Top Debtors",
      topRentablesTitle: "Top Properties by Revenue",
      ingresos: "Revenue",
      egresos: "Expenses",
      neto: "Net",
      deuda: "debt",
      ingresoTotal: "total revenue",
    ...
    cmms: {
      ...
      failures: "failures",
      hours: "hrs",
      totalOts: "work orders",
      pmOnTarget: "On target",
      pmImprove: "Needs improvement",
      pmCritical: "Critical",
    },
  },
  ...
  config: {
    ...
    notifications: {
      ...
      testEmailRecipient: "Send test email to",
      ...
      templateChannelInApp: "In-app",
      templateEventType: "Event Type",
      templateEventTypePlaceholder: "E.g.: user.created, order.completed",
      templateSubject: "Subject",
      templateSubjectPlaceholder: "Email subject",
      templateBody: "Body",
      templateBodyPlaceholder: "Message body",
      templateIsActive: "Active",
      templateVariables: "Available Variables",
      templateVariablesDesc: "Variables you can use in templates",
    ...
    files: {
      ...
      description: "Configure storage, limits, and thumbnails for files",
      errorLoading: "Error loading configuration",
      tabs: {
        storage: "Storage",
        stats: "Statistics",
      ...
      storage: {
        ...
        description: "Configure the storage backend (Local, S3, or Hybrid)",
        backend: "Storage Backend",
        local: "Local",
        s3: "S3 (AWS)",
        hybrid: "Hybrid",
        localBasePath: "Local Base Path",
        localBasePathDescription:
          "Filesystem path where files will be stored",
        ...
        s3SecretKeyDescription:
          "The secret key is encrypted before being saved",
        testConnection: "Test Connection",
        testing: "Testing...",
        testSuccess: "S3 connection successful",
        testError: "Error testing S3 connection",
        updated: "Storage configuration updated successfully",
        updateError: "Error updating storage configuration",
      },
      stats: {
        title: "Storage Statistics",
        description: "Storage usage statistics and file distribution",
        totalSpace: "Total Space Used",
        totalFiles: "Total Files",
        totalFolders: "Total Folders",
        totalVersions: "Total Versions",
        mimeDistribution: "Distribution by MIME Type",
        entityDistribution: "Distribution by Entity",
        filesWithPermissions: "Files with Permissions",
        foldersWithPermissions: "Folders with Permissions",
      ...
      quota: {
        title: "Storage Quota",
        description:
          "Configure the tenant-wide quota and each user's default personal quota, with threshold warnings",
        tenantUsage: "Tenant total usage",
        of: "of",
        used: "used",
        tenantMaxLabel: "Tenant max quota",
        tenantMaxDesc:
          "Total space available for personal files across the whole tenant (in MB)",
        tenantThresholdsLabel: "Tenant warning thresholds (%)",
        userDefaultMaxLabel: "Default personal quota",
        userDefaultMaxDesc:
          "Space available to each user by default, unless they have a custom limit (in MB)",
        userThresholdsLabel: "Personal warning thresholds (%)",
        thresholdsDesc:
          "Comma-separated percentages at which a warning will be sent, e.g: 75, 90, 100",
        perUserTitle: "Usage by user",
        user: "User",
        usage: "Current usage",
        limit: "Limit",
        ...
        updated: "Storage quota updated successfully",
        updateError: "Error updating storage quota",
        userOverrideUpdated: "Custom limit updated successfully",
        userOverrideUpdateError: "Error updating custom limit",
      },
      limits: {
        title: "Limits and Policies",
        description:
          "Configure size limits, allowed MIME types, and retention policies",
        maxFileSize: "Maximum File Size",
        maxFileSizeDescription: "Maximum allowed size for uploaded files (in MB)",
        maxVersionsPerFile: "Maximum Versions per File",
        maxVersionsDescription:
          "Maximum number of versions that can be kept per file",
        retentionDays: "Retention Days",
        retentionDaysDescription:
          "Days before deleting old files (leave empty for no limit)",
        noLimit: "No limit",
        allowedMimeTypes: "Allowed MIME Types",
        allowedMimeTypesDescription:
          "List of allowed MIME types (one per line). Leave empty to allow all.",
        blockedMimeTypes: "Blocked MIME Types",
        blockedMimeTypesDescription: "List of blocked MIME types (one per line)",
        updated: "Limits updated successfully",
        updateError: "Error updating limits",
      },
      thumbnails: {
        title: "Thumbnail Configuration",
        description: "Configure thumbnail size, quality, and cache",
        defaultWidth: "Default Width",
        defaultWidthDescription: "Default thumbnail width in pixels",
        defaultHeight: "Default Height",
        defaultHeightDescription: "Default thumbnail height in pixels",
        quality: "JPEG Quality",
        qualityDescription: "JPEG compression quality (1-100, higher = better)",
        cacheEnabled: "Enable Cache",
        cacheEnabledDescription: "Enable thumbnail cache to improve performance",
        maxCacheSize: "Maximum Cache Size",
        maxCacheSizeDescription: "Maximum thumbnail cache size (in MB)",
        updated: "Thumbnail configuration updated successfully",
        updateError: "Error updating thumbnail configuration",
      },
    },
  },
  // Activity Icons
  ...
  calendar: {
    ...
    infoNote: {
      addFilesAndComments:
        "To attach comments and add relevant files, open the newly created task",
    },
  },
  // Integrations module
  integrations: {
  ...
  license: {
    ...
    activate: {
      ...
      label: "License token",
      placeholder: "Paste JWT license token...",
      submit: "Activate",
    ...
    revoke: {
      ...
      confirm: "Are you sure you want to revoke this license?",
      submit: "Revoke",
  ...
  tier: {
    upgrade: {
      ...
      description:
        "The {{module}} module requires the {{required}} plan. Your current plan is {{current}}.",
      cta: "Upgrade plan",
    },
    current: {
      label: "Current plan",
  ...
  maintenance: {
    ...
    workOrder: {
      ...
      fields: {
        ...
        billedTo: "Billed To",
        sla: "SLA Due",
        fotosInspeccion: "Inspection Photos",
        fotosTrabajo: "Work Photos",
        photos: "Photos",
      ...
      transitions: {
        fotosDespuesRequired: "After-work photos are required to send for approval",
        photosRequired: "Required photos are missing",
      },
      messages: {
        uploadPhotoError: "Failed to upload photo. Please try again.",
        noReportYet: "No report has been added for this stage yet.",
      },
      validation: {
