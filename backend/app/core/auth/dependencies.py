...
async def get_optional_user(
    ...
    """Extract and validate JWT from Authorization header without raising on missing/invalid token.

    Use this in public routes that need to know *who* is calling (if anyone),
    but must not block unauthenticated requests.

    Returns:
        User if a valid Bearer token is present and the user is active, None otherwise.
    """
