/**
 * Spanish translations for Tasks module
 */
...
export const tasksTranslations = {
  ...
  templates: {
    ...
    noTemplatesDescription:
      "No se encontraron plantillas. Crea una nueva plantilla para comenzar.",
    category: "Categoría",
    estimatedDuration: "Duración estimada",
    minutes: "minutos",
  ...
  bulkActions: {
    ...
    confirmDelete: "¿Eliminar las tareas seleccionadas?",
  },
  savedViews: {
  ...
  timeTracking: {
    ...
    noEntries: "Sin registros de tiempo",
  },
  subtasks: {
    title: "Subtareas",
    add: "Agregar subtarea",
    completed: "completadas",
    newPlaceholder: "Título de la subtarea...",
    maxDepth: "Profundidad máxima alcanzada",
    circularDependency: "Dependencia circular detectada",
  },
  checklist: {
    title: "Checklist",
    addItem: "Agregar item",
