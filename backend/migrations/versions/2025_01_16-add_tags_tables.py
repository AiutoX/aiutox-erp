...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"], ["tag_categories.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "ix_tag_categories_tenant_id", "tag_categories", ["tenant_id"], unique=False
    )
    op.create_index(
        "idx_tag_categories_tenant_name",
        "tag_categories",
        ["tenant_id", "name"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["category_id"], ["tag_categories.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        "idx_tags_category", "tags", ["tenant_id", "category_id"], unique=False
    )
    ...
    op.create_index(
        "ix_entity_tags_tenant_id", "entity_tags", ["tenant_id"], unique=False
    )
    op.create_index("ix_entity_tags_tag_id", "entity_tags", ["tag_id"], unique=False)
    op.create_index(
        "ix_entity_tags_entity_type", "entity_tags", ["entity_type"], unique=False
    )
    op.create_index(
        "ix_entity_tags_entity_id", "entity_tags", ["entity_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_entity_tags_tenant_entity",
        "entity_tags",
        ["tenant_id", "entity_type", "entity_id"],
        unique=False,
    )
    op.create_index(
        "idx_entity_tags_unique",
        "entity_tags",
