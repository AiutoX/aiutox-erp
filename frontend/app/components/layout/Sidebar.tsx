    ...
    <>
      ...
      <aside
        ...
        className={cn(
          ...
          "w-64 bg-sidebar shadow-[2px_0_8px_rgba(0,0,0,0.04)]",
      ...
      >
        {/* Logo/Header */}
        <div className="h-16 px-4 flex items-center justify-center bg-sidebar overflow-hidden transition-all duration-200">
        ...
        <div className="hidden lg:flex items-center justify-center h-12 bg-sidebar">
          <Button
            variant="ghost"
            size="icon"
