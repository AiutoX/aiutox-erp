...
function HeaderComponent({
  ...
  const { showDarkModeToggle } = useThemeConfig();
  ...
  return (
    ...
    >
      ...
      {/* Sección centro: GlobalSearch (Cmd+K) */}
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Theme Toggle — hidden when the tenant disabled dark mode or has no dark_* overrides configured */}
        {showDarkModeToggle && (
          <Button
            variant="ghost"
            size="icon"
