...
class TasksCoreModule(ModuleInterface):
    ...
    def get_widgets(self) -> list[WidgetManifest]:
        return [
            WidgetManifest(
                ...
                # features/tasks/widgets/UpcomingTasksWidget.tsx (the resolver
    ...
    def get_import_export_handler(self):
        from app.core.db.session import SessionLocal
        from app.core.tasks.import_export_handler import TasksImportExportHandler

        return TasksImportExportHandler(SessionLocal())

    def get_search_handler(self):
        from app.core.tasks.search_provider import TasksSearchProvider

        return TasksSearchProvider()
