...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_calendar_events_source_type",
        "calendar_events",
        ["source_type"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_calendar_events_source_id", "calendar_events", ["source_id"], unique=False
    )
    ...
    op.create_index(
        "ix_calendar_events_provider", "calendar_events", ["provider"], unique=False
    )
    ...
    op.create_index(
        "ix_calendar_events_external_id",
        "calendar_events",
        ["external_id"],
        unique=False,
    )
    ...
    op.add_column(
        "calendar_events",
        sa.Column(
            "recurrence_exdates", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    )
    ...
    op.create_index(
        "ix_calendar_resources_tenant_id",
        "calendar_resources",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        "ix_calendar_resources_calendar_id",
        "calendar_resources",
        ["calendar_id"],
        unique=False,
    )
    op.create_index(
        "ix_calendar_resources_resource_type",
        "calendar_resources",
        ["resource_type"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_event_resources_tenant_id", "event_resources", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_event_resources_event_id", "event_resources", ["event_id"], unique=False
    )
    op.create_index(
        "ix_event_resources_resource_id",
        "event_resources",
        ["resource_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_calendar_resources_resource_type", table_name="calendar_resources"
    )
