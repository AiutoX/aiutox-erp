...
@router.post(
    ...
    description="Create a new folder. Requires files.write permission.",
)
...
@router.put(
    ...
    description="Update a folder. Requires files.write permission.",
)
...
@router.post(
    ...
    response_model=StandardResponse[FolderResponse],
    summary="Move folder",
    description="Move a folder to a new parent. Requires files.write permission.",
)
...
@router.post(
    ...
    description="Move files and folders to a target folder. Requires files.write permission.",
)
