...
down_revision: str | None = "add_reporting_tables"
...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_notification_templates_tenant_event",
        "notification_templates",
        ["tenant_id", "event_type"],
        unique=False,
    )
    op.create_index(
        "idx_notification_templates_event_channel",
        "notification_templates",
        ["event_type", "channel"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_notification_queue_event_type",
        "notification_queue",
        ["event_type"],
        unique=False,
    )
    op.create_index(
        "ix_notification_queue_recipient_id",
        "notification_queue",
        ["recipient_id"],
        unique=False,
    )
    op.create_index(
        "ix_notification_queue_tenant_id",
        "notification_queue",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        "ix_notification_queue_channel", "notification_queue", ["channel"], unique=False
    )
    op.create_index(
        "ix_notification_queue_template_id",
        "notification_queue",
        ["template_id"],
        unique=False,
    )
    op.create_index(
        "ix_notification_queue_status", "notification_queue", ["status"], unique=False
    )
    op.create_index(
        "ix_notification_queue_created_at",
        "notification_queue",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        "idx_notification_queue_status", "notification_queue", ["status"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_notification_templates_event_channel", table_name="notification_templates"
    )
    op.drop_index(
        "idx_notification_templates_tenant_event", table_name="notification_templates"
    )
    op.drop_index(
        "ix_notification_templates_event_type", table_name="notification_templates"
    )
    op.drop_index(
        "ix_notification_templates_tenant_id", table_name="notification_templates"
    )
