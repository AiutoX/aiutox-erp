...
export interface AutomationCondition {
  ...
  value: unknown;
  // Inverts the operator's result (e.g. operator "in" + negate: true means
  // "not in"). Generic mechanism instead of separate not_in/not_contains
  // operators — see condition_evaluator.py.
  negate?: boolean;
