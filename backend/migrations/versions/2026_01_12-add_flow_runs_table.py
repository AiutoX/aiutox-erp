...
down_revision: str | None = "add_steps_form_print_config"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["flow_id"], ["approval_flows.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        "ix_flow_runs_entity_type", "flow_runs", ["entity_type"], unique=False
    )
    ...
    op.create_index(
        "idx_flow_runs_tenant_entity",
        "flow_runs",
        ["tenant_id", "entity_type", "entity_id"],
        unique=False,
    )
    op.create_index(
        "idx_flow_runs_status_tenant",
        "flow_runs",
        ["status", "tenant_id"],
        unique=False,
    )
    op.create_index(
        "idx_flow_runs_flow_tenant", "flow_runs", ["flow_id", "tenant_id"], unique=False
    )
