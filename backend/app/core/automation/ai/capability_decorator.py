...
def agent_capability(
    *,
    ...
    def decorator(fn: Callable[..., Any]) -> Callable[..., Any]:
        ...
        # Expected module path: app.modules.{slug}.ai.capabilities or
        # app.core.{slug}.ai.capabilities (core/infrastructure modules)
        # [-3] gives the module slug in both cases
