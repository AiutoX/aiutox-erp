...
import { ChannelIdentitiesSection } from "~/features/integrations/components/ChannelIdentitiesSection";
...
export default function SettingsPage() {
  ...
  return (
    ...
    >
      <Tabs defaultValue="localization" className="max-w-3xl">
