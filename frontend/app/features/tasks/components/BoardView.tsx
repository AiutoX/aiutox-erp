      ...
      {sortedStatuses.map((status) => {
        ...
        return (
          <div
            key={status.id}
            className={cn(
              "flex min-w-70 max-h-150 flex-col rounded-lg transition-all",
          ...
          >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-semibold text-foreground">
                      {statusNameToKey[status.name]
                        ? t(`tasks.statuses.${statusNameToKey[status.name]}`)
                        : status.name}
                    </h3>
                  </div>
            ...
            {/* Tasks list */}
            <div className="flex-1 space-y-1.5 overflow-y-auto min-h-100">
