...
down_revision: str | None = "add_preferences_tables"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_report_definitions_tenant_id",
        "report_definitions",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        "ix_report_definitions_data_source_type",
        "report_definitions",
        ["data_source_type"],
        unique=False,
    )
    op.create_index(
        "ix_report_definitions_created_by",
        "report_definitions",
        ["created_by"],
        unique=False,
    )
    op.create_index(
        "idx_report_definitions_tenant",
        "report_definitions",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        "idx_report_definitions_data_source",
        "report_definitions",
        ["data_source_type"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_dashboard_widgets_report_definition_id",
        "dashboard_widgets",
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_dashboard_widgets_report_definition_id", table_name="dashboard_widgets"
    )
    ...
    op.drop_index(
        "ix_report_definitions_data_source_type", table_name="report_definitions"
    )
