...
down_revision: str | None = "add_approvals_tables"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_templates_template_type", "templates", ["template_type"], unique=False
    )
    op.create_index("ix_templates_category", "templates", ["category"], unique=False)
    op.create_index(
        "ix_templates_created_by", "templates", ["created_by"], unique=False
    )
    op.create_index(
        "idx_templates_tenant_type",
        "templates",
        ["tenant_id", "template_type"],
        unique=False,
    )
    op.create_index(
        "idx_templates_category", "templates", ["tenant_id", "category"], unique=False
    )
    ...
    op.create_index(
        "ix_template_versions_tenant_id",
        "template_versions",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_template_versions_is_current",
        "template_versions",
        ["is_current"],
        unique=False,
    )
    op.create_index(
        "ix_template_versions_created_by",
        "template_versions",
        ["created_by"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"], ["template_categories.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.create_index(
        "idx_template_categories_tenant",
        "template_categories",
        ["tenant_id", "name"],
        unique=False,
    )
