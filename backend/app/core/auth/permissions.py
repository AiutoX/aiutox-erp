...
MODULE_ROLES: dict[str, dict[str, set[str]]] = {
    ...
    "files": {
        "internal.viewer": {"files.read"},
        "internal.editor": {"files.read", "files.write"},
        "internal.manager": {
            "files.read",
            "files.write",
            "files.delete",
    ...
    "notifications": {
        "internal.viewer": {"notifications.read"},
        "internal.editor": {"notifications.read", "notifications.write"},
        "internal.manager": {
            "notifications.read",
            "notifications.write",
    ...
    "automation": {
        "internal.viewer": {"automation.read"},
        "internal.editor": {"automation.read", "automation.write"},
        "internal.manager": {
            "automation.read",
            "automation.write",
            "automation.delete",
