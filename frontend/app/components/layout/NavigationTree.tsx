...
function NavigationItemComponent({
  ...
  return (
    <Link
      ...
      title={
        isCollapsed || displayLabel.length > LONG_LABEL_TOOLTIP_THRESHOLD
          ? displayLabel
          : undefined
      }
    >
  ...
  return (
    <div className="space-y-0.5">
      <button
        onClick={() => setIsExpanded(!isExpanded)}
        className={cn(
          "w-full flex items-center gap-2 px-4 py-1.5 text-sm font-medium rounded-md mx-2",
          "transition-all duration-150 ease-in-out",
      ...
      {isExpanded && (
        <div className="ml-6 space-y-0.5 border-l border-border/50 pl-1">
      ...
      >
        <div className="space-y-1 m-1">
          ...
          <CollapsibleContent className="ml-1 space-y-3 pt-1">
            ...
            {coreGroups.length > 0 && (
              <div className="space-y-0.5">
                <p className="px-4 pt-1 pb-1 text-[10px] font-semibold text-muted-foreground/50 uppercase tracking-widest">
                  Sistema
                </p>
