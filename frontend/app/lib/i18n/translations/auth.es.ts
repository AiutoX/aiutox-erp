  ...
  auth: {
    login: {
      ...
      error: {
        ...
        serverError:
          "Error del servidor. Por favor contacta al administrador o verifica que el backend esté funcionando correctamente.",
        network:
    ...
    resetPassword: {
      missingToken: "Token de restablecimiento no válido o faltante.",
    ...
    verifyEmail: {
      error: {
        notImplemented:
          "La verificación de email aún no está disponible. El endpoint será implementado próximamente.",
        AUTH_TOKEN_INVALID:
          "El enlace de verificación ha expirado o es inválido.",
        generic: "Error al verificar el email. Por favor intenta nuevamente.",
        missingToken: "Token de verificación no válido o faltante.",
      },
    },
    password: {
      current: {
