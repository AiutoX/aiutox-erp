...
from app.core.widgets.service import WidgetPreferenceService, _build_widget_registry
...
def get_available_widgets(
    ...
    manifests = registry.get_available_widgets(
        current_user.tenant_id, user_permissions=user_permissions
    )
