...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_task_dependencies_tenant_id"),
        "task_dependencies",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_task_resources_tenant_id"),
        "task_resources",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_task_resources_task_id"), "task_resources", ["task_id"], unique=False
    )
    op.create_index(
        op.f("ix_task_resources_resource_id"),
        "task_resources",
        ["resource_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_task_dependencies_tenant_id"), table_name="task_dependencies"
    )
