...
class ConfigCache:
    ...
    def invalidate_module(self, tenant_id: UUID, module: str) -> int:
        ...
        try:
            ...
            if keys_to_delete:
                return self._redis_client.delete(*keys_to_delete)  # type: ignore[return-value]
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        try:
            ...
            # Get Redis info
            info = self._redis_client.info("memory")  # type: ignore[union-attr]
            ...
            return {
                ...
                "ttl": self.ttl,
                "memory_used": info.get("used_memory_human", "unknown"),  # type: ignore[union-attr]
            }
        except RedisError as e:
