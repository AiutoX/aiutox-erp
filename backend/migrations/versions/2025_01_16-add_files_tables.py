...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_files_entity", "files", ["entity_type", "entity_id"], unique=False
    )
    op.create_index(
        "idx_files_tenant_entity",
        "files",
        ["tenant_id", "entity_type", "entity_id"],
        unique=False,
    )
    op.create_index(
        "idx_files_current", "files", ["tenant_id", "is_current"], unique=False
    )
    ...
    op.create_index(
        "ix_file_versions_tenant_id", "file_versions", ["tenant_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "can_edit", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_file_permissions_file_id", "file_permissions", ["file_id"], unique=False
    )
    op.create_index(
        "ix_file_permissions_tenant_id", "file_permissions", ["tenant_id"], unique=False
    )
    op.create_index(
        "idx_file_permissions_file", "file_permissions", ["file_id"], unique=False
    )
    op.create_index(
        "idx_file_permissions_target",
        "file_permissions",
        ["target_type", "target_id"],
        unique=False,
    )
    op.create_index(
        "idx_file_permissions_tenant",
        "file_permissions",
