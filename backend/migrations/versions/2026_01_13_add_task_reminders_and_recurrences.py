...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_task_reminders_task_id", "task_reminders", ["task_id"], unique=False
    )
    op.create_index(
        "ix_task_reminders_tenant_id", "task_reminders", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_task_reminders_reminder_time",
        "task_reminders",
        ["reminder_time"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_task_reminders_tenant",
        "task_reminders",
        ["tenant_id", "reminder_time"],
        unique=False,
    )
    op.create_index(
        "idx_task_reminders_pending",
        "task_reminders",
        ["tenant_id", "sent", "reminder_time"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "custom_config", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_task_recurrences_task_id", "task_recurrences", ["task_id"], unique=False
    )
    op.create_index(
        "ix_task_recurrences_tenant_id", "task_recurrences", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_task_recurrences_start_date",
        "task_recurrences",
        ["start_date"],
        unique=False,
    )
    op.create_index(
        "ix_task_recurrences_end_date", "task_recurrences", ["end_date"], unique=False
    )
    op.create_index(
        "ix_task_recurrences_active", "task_recurrences", ["active"], unique=False
    )
    op.create_index(
        "idx_task_recurrences_task",
        "task_recurrences",
        ["task_id", "active"],
        unique=False,
    )
    op.create_index(
        "idx_task_recurrences_tenant",
        "task_recurrences",
        ["tenant_id", "active"],
        unique=False,
    )
    op.create_index(
        "idx_task_recurrences_dates",
        "task_recurrences",
