...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "calendar_type", sa.String(length=20), nullable=False, server_default="user"
        ),
    ...
    op.create_index(
        "ix_calendars_organization_id", "calendars", ["organization_id"], unique=False
    )
    op.create_index(
        "idx_calendars_tenant_owner",
        "calendars",
        ["tenant_id", "owner_id"],
        unique=False,
    )
    op.create_index(
        "idx_calendars_organization",
        "calendars",
    ...
    op.create_table(
        ...
        sa.Column(
            "recurrence_end_date", postgresql.TIMESTAMP(timezone=True), nullable=True
        ),
    ...
    op.create_index(
        "ix_calendar_events_tenant_id", "calendar_events", ["tenant_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_calendar_events_end_time", "calendar_events", ["end_time"], unique=False
    )
    op.create_index(
        "ix_calendar_events_status", "calendar_events", ["status"], unique=False
    )
    op.create_index(
        "ix_calendar_events_organizer_id",
        "calendar_events",
        ["organizer_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_events_status", "calendar_events", ["tenant_id", "status"], unique=False
    )
    ...
    op.create_index(
        "ix_event_attendees_tenant_id", "event_attendees", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_event_attendees_event_id", "event_attendees", ["event_id"], unique=False
    )
    op.create_index(
        "ix_event_attendees_user_id", "event_attendees", ["user_id"], unique=False
    )
    op.create_index(
        "ix_event_attendees_status", "event_attendees", ["status"], unique=False
    )
    op.create_index(
        "idx_attendees_event_user",
        "event_attendees",
        ["event_id", "user_id"],
        unique=False,
    )
    op.create_index(
        "idx_attendees_status", "event_attendees", ["event_id", "status"], unique=False
    )
    ...
    op.create_index(
        "ix_event_reminders_tenant_id", "event_reminders", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_event_reminders_event_id", "event_reminders", ["event_id"], unique=False
    )
    op.create_index(
        "ix_event_reminders_is_sent", "event_reminders", ["is_sent"], unique=False
    )
    op.create_index(
        "idx_reminders_event_sent",
        "event_reminders",
        ["event_id", "is_sent"],
        unique=False,
    )
