...
export function UserForm({
  ...
  const onSubmitForm = async (
    ...
    let finalData: Partial<UserCreate | UserUpdate> = {};
    ...
    try {
      ...
      if (isSelfEdit) {
        ...
        forbiddenFields.forEach((field) => {
          delete (finalData as Record<string, unknown>)[field];
        });
      ...
      console.warn("[UserForm] Final data to submit:", finalData);
      ...
      console.error("[UserForm] Data that caused error:", finalData);
      throw error;
    }
  };
