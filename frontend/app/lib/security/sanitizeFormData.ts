...
export function sanitizeUserFormData(
  ...
  // Handle remaining optional fields - empty string is not a valid value for
  // these on the backend (e.g. date_of_birth rejects "" with a 422), so an
  // unset field must be sent as null rather than left as an empty string.
