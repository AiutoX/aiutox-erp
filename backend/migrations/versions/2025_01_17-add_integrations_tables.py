...
down_revision: str | None = "add_search_tables"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_integrations_tenant_id", "integrations", ["tenant_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "method", sa.String(length=10), nullable=False, server_default="POST"
        ),
    ...
    op.create_index(
        "ix_webhooks_integration_id", "webhooks", ["integration_id"], unique=False
    )
    ...
    op.create_index(
        "idx_webhooks_tenant_event",
        "webhooks",
        ["tenant_id", "event_type"],
        unique=False,
    )
    op.create_index(
        "idx_webhooks_tenant_enabled",
        "webhooks",
        ["tenant_id", "enabled"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_webhook_deliveries_status", "webhook_deliveries", ["status"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_webhook_deliveries_tenant_created",
        "webhook_deliveries",
    ...
    op.create_index(
        "ix_integration_logs_integration_id",
        "integration_logs",
        ["integration_id"],
        unique=False,
    )
    op.create_index(
        "ix_integration_logs_tenant_id", "integration_logs", ["tenant_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_integration_logs_integration_created",
        "integration_logs",
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_integration_logs_integration_created", table_name="integration_logs"
    )
    ...
    op.drop_index(
        "idx_webhook_deliveries_tenant_created", table_name="webhook_deliveries"
    )
    op.drop_index(
        "idx_webhook_deliveries_webhook_status", table_name="webhook_deliveries"
    )
