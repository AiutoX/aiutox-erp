...
def get_event_publisher() -> EventPublisher:
    """Dependency to get EventPublisher."""
...
@router.post(
    ...
    description="Create a new automation rule. Requires automation.write permission.",
)
async def create_rule(
    rule_data: RuleCreate,
    current_user: Annotated[User, Depends(require_permission("automation.write"))],
...
@router.get(
    ...
    description="List all automation rules for the current tenant. Requires automation.read permission.",
)
...
@router.get(
    ...
    description="Get a specific automation rule by ID. Requires automation.read permission.",
)
async def get_rule(
    rule_id: UUID,
    current_user: Annotated[User, Depends(require_permission("automation.read"))],
...
@router.put(
    ...
    description="Update an automation rule. Requires automation.write permission.",
)
...
@router.delete(
    ...
    description="Delete an automation rule. Requires automation.delete permission.",
)
...
@router.post(
    ...
    description="Execute an automation rule manually with a test event. Requires automation.admin permission.",
)
async def execute_rule(
    rule_id: UUID,
    current_user: Annotated[User, Depends(require_permission("automation.admin"))],
    service: Annotated[AutomationService, Depends(get_automation_service)],
...
@router.get(
    ...
    description="Get execution history for a rule. Requires automation.read permission.",
)
