...
MODULE_ROLES: dict[str, dict[str, set[str]]] = {
    "maintenance": {
        "internal.inquilino": {
            # Tenant portal — create and view own maintenance requests
            "maintenance.request.create",
            "maintenance.request.view_own",
        },
        "internal.viewer": {
            "maintenance.view",
        },
        "internal.editor": {
            "maintenance.view",
            "maintenance.edit",
            "maintenance.work_order.transition",
        },
        "internal.manager": {
            "maintenance.view",
            "maintenance.edit",
            ...
            "maintenance.manage",
            "maintenance.work_order.transition",
            "maintenance.work_order.approve_cost",
            "maintenance.manage_users",
            # Request portal (Phase 2)
            "maintenance.request.create",
            "maintenance.request.view_own",
            ...
            "maintenance.material_requests.view_own",
            "maintenance.material_requests.view_all_in_property",
            "maintenance.material_requests.approve_reject",
            "maintenance.material_requests.view_approval_queue",
            "inventory.material_requests.view_pending_resolution",
            "inventory.material_requests.resolve",
            "inventory.material_requests.bulk_resolve",
            "inventory.material_requests.mark_fulfilled",
            "maintenance.material_request_approval_flow.view",
            "maintenance.material_request_approval_flow.configure",
            # Work order billing/creation
            "maintenance.create_invoice",
            "maintenance.create_request",
            "maintenance.manage_workorder",
        },
    },
    "inventory": {
        "internal.viewer": {
        ...
        "internal.editor": {
            ...
            "inventory.adjust",
            "inventory.movements.view",
            "inventory.operations.confirm",
            "inventory.operations.validate",
            "inventory.operations.cancel",
            "inventory.order_points.manage",
        },
        "internal.manager": {
            "inventory.view",
            "inventory.manage",
            ...
            # Material requests resolution (Issue 004)
            "inventory.material_requests.view_pending_resolution",
            "inventory.material_requests.resolve",
            "inventory.material_requests.bulk_resolve",
            "inventory.material_requests.mark_fulfilled",
    ...
    "tasks": {
        ...
        # tasks.manage is the router's actual write permission (create/update/
        # delete on own tasks, see app/core/tasks/routers/tasks_core.py) —
        # tasks.create/tasks.edit are not checked by any tasks endpoint.
        "internal.editor": {"tasks.view", "tasks.manage"},
        "internal.manager": {
            "tasks.view",
            "tasks.manage",
            "tasks.manage_users",
    ...
    "files": {
        ...
        "internal.editor": {"files.view", "files.edit"},
        "internal.manager": {
            "files.view",
            "files.edit",
            "files.delete",
    ...
    "gamification": {
        "internal.viewer": {"gamification.view"},
        "internal.manager": {"gamification.view", "gamification.manage"},
    },
    "notifications": {
    ...
    "automation": {
        ...
        "internal.editor": {"automation.view", "automation.edit"},
        "internal.manager": {
            "automation.view",
            "automation.edit",
            "automation.delete",
    ...
    "data_collection": {
        "internal.viewer": {
            "data_collection.forms.view",
            "data_collection.analytics.view",
            "data_collection.dashboards.view",
            "data_collection.submissions.view",
            "data_collection.submissions.create",
            "data_collection.cases.view",
        },
        "internal.editor": {
            "data_collection.forms.view",
            "data_collection.forms.create",
            "data_collection.forms.edit",
            "data_collection.forms.publish",
            "data_collection.analytics.view",
            "data_collection.dashboards.view",
            "data_collection.dashboards.create",
            "data_collection.dashboards.edit",
            "data_collection.submissions.view",
            "data_collection.submissions.create",
            "data_collection.submissions.edit",
            "data_collection.cases.view",
        },
        "internal.manager": {
            "data_collection.forms.view",
            "data_collection.forms.create",
            "data_collection.forms.edit",
            "data_collection.forms.delete",
            "data_collection.forms.publish",
            "data_collection.forms.archive",
            "data_collection.forms.manage",
            "data_collection.analytics.view",
            "data_collection.dashboards.view",
            "data_collection.dashboards.create",
            "data_collection.dashboards.edit",
            "data_collection.dashboards.delete",
            "data_collection.submissions.view",
            "data_collection.submissions.create",
            "data_collection.submissions.edit",
            "data_collection.submissions.delete",
            "data_collection.submissions.export",
            "data_collection.submissions.approve",
            "data_collection.cases.view",
            "data_collection.cases.manage",
            "data_collection.encryption.manage",
            "data_collection.lookup_tables.manage",
            "data_collection.manage_users",
        },
    },
    "finances": {
        "internal.viewer": {
    ...
    "leases": {
        # Tenant portal — view own lease only (scoped in the service/router
        # layer by tenant_person_id, same pattern as maintenance's
        # internal.inquilino)
        "internal.inquilino": {
            "leases.read",
        },
        ...
        "internal.manager": {
            ...
            "leases.transition",
            "leases.ipc_adjustment",
            "leases.legal_notifications",
            "leases.payment_agreements",
        },
    },
    "properties": {
        "internal.viewer": {
            "properties.buildings.read",
            "properties.properties.read",
            "properties.assets.read",
        },
        "internal.editor": {
            "properties.buildings.read",
            "properties.buildings.write",
            "properties.properties.read",
            "properties.properties.write",
            "properties.assets.read",
            "properties.assets.write",
        },
        "internal.manager": {
            "properties.buildings.read",
            "properties.buildings.write",
            "properties.buildings.admin",
            "properties.properties.read",
            "properties.properties.write",
