  ...
  auth: {
    login: {
      ...
      error: {
        ...
        serverError:
          "Server error. Please contact the administrator or check that the backend is running correctly.",
        network:
    ...
    forgotPassword: {
      linkSentMessage:
        "If the email exists in our system, you will receive a recovery link.",
    },
    resetPassword: {
      ...
      error: {
        AUTH_TOKEN_INVALID:
          "The link has expired or is invalid. Please request a new recovery link.",
        AUTH_REFRESH_TOKEN_INVALID:
          "The link has expired or is invalid. Please request a new recovery link.",
        generic: "Error resetting password. Please try again.",
      },
    },
    verifyEmail: {
      error: {
        notImplemented:
          "Email verification is not available yet. The endpoint will be implemented soon.",
        AUTH_TOKEN_INVALID: "The verification link has expired or is invalid.",
        generic: "Error verifying email. Please try again.",
        missingToken: "Invalid or missing verification token.",
      },
    },
    password: {
      current: {
