...
const getAvailableIntegrations = (t: (key: string) => string) =>
  [
    {
      id: "stripe",
      name: t("config.integrations.stripeName"),
      description: t("config.integrations.stripeDesc"),
    },
    {
      id: "twilio",
      name: t("config.integrations.twilioName"),
      description: t("config.integrations.twilioDesc"),
    },
    {
      id: "google-calendar",
      name: t("config.integrations.googleCalendarName"),
      description: t("config.integrations.googleCalendarDesc"),
    },
    {
      id: "slack",
      name: t("config.integrations.slackName"),
      description: t("config.integrations.slackDesc"),
    },
    {
      id: "zapier",
      name: t("config.integrations.zapierName"),
      description: t("config.integrations.zapierDesc"),
    },
    {
      id: "webhook",
      name: t("config.integrations.webhookName"),
      description: t("config.integrations.webhookDesc"),
    },
    {
      id: "telegram",
      name: t("config.integrations.telegramName"),
      description: t("config.integrations.telegramDesc"),
    },
    {
      id: "whatsapp",
      name: t("config.integrations.whatsappName"),
      description: t("config.integrations.whatsappDesc"),
    },
    {
      id: "mattermost",
      name: t("config.integrations.mattermostName"),
      description: t("config.integrations.mattermostDesc"),
    },
    {
      id: "rocketchat",
      name: t("config.integrations.rocketchatName"),
      description: t("config.integrations.rocketchatDesc"),
    },
  ] as const;
...
export default function IntegrationsConfigPage() {
  ...
  const activateMutation = useMutation({
    ...
    onError: (error: Error) => {
      showToast(
        error.message || t("config.integrations.errorActivating"),
        "error"
      );
    },
  });
  ...
  const deactivateMutation = useMutation({
    ...
    onError: (error: Error) => {
      showToast(
        error.message || t("config.integrations.errorDeactivating"),
        "error"
      );
    },
  });
  ...
  const testMutation = useMutation({
    ...
    onSuccess: (response) => {
      if (response.data.success) {
        ...
        showToast(
          response.data.message || t("config.integrations.testError"),
          "error"
        );
      }
    },
      ...
      case "active":
        return (
          <Badge className="bg-green-50 text-green-700 border-green-200">
            {t("config.integrations.statusActive")}
          </Badge>
        );
      case "inactive":
        return (
          <Badge variant="secondary">
            {t("config.integrations.statusInactive")}
          </Badge>
        );
      case "error":
        return (
          <Badge variant="destructive">
            {t("config.integrations.statusError")}
          </Badge>
        );
      case "pending":
        return (
          <Badge variant="outline">
            {t("config.integrations.statusPending")}
          </Badge>
        );
      default:
        return null;
  ...
  const handleConfigure = (
    integration: (typeof availableIntegrations)[number]
  ) => {
    ...
    switch (type) {
      case "stripe":
        return [
          {
            key: "api_key",
            label: t("config.integrations.apiKey"),
            type: "password",
          },
          {
            key: "webhook_secret",
            label: t("config.integrations.webhookSecret"),
            type: "password",
          },
        ];
      case "twilio":
        return [
          {
            key: "account_sid",
            label: t("config.integrations.accountSid"),
            type: "text",
          },
          {
            key: "auth_token",
            label: t("config.integrations.authToken"),
            type: "password",
          },
          {
            key: "from_number",
            label: t("config.integrations.fromNumber"),
            type: "text",
            placeholder: t("config.integrations.fromNumberPlaceholder"),
          },
        ];
      case "google-calendar":
        return [
          {
            key: "client_id",
            label: t("config.integrations.clientId"),
            type: "text",
          },
          {
            key: "client_secret",
            label: t("config.integrations.clientSecret"),
            type: "password",
          },
        ];
      case "slack":
        return [
          {
            key: "webhook_url",
            label: t("config.integrations.webhookUrl"),
            type: "url",
          },
        ];
      case "zapier":
      ...
      case "telegram":
        return [
          {
            key: "bot_token",
            label: t("config.integrations.telegramBotToken"),
            type: "password",
          },
          {
            key: "webhook_secret",
            label: t("config.integrations.telegramWebhookSecret"),
            type: "password",
          },
        ];
      case "whatsapp":
        return [
          {
            key: "api_url",
            label: t("config.integrations.whatsappApiUrl"),
            type: "text",
          },
          {
            key: "api_key",
            label: t("config.integrations.whatsappApiKey"),
            type: "password",
          },
          {
            key: "instance_name",
            label: t("config.integrations.whatsappInstanceName"),
            type: "text",
          },
        ];
      case "mattermost":
        return [
          {
            key: "webhook_url",
            label: t("config.integrations.mattermostWebhookUrl"),
            type: "url",
          },
          {
            key: "channel",
            label: t("config.integrations.mattermostChannel"),
            type: "text",
          },
          {
            key: "username",
            label: t("config.integrations.mattermostUsername"),
            type: "text",
          },
          {
            key: "icon_url",
            label: t("config.integrations.mattermostIconUrl"),
            type: "text",
          },
        ];
      case "rocketchat":
        return [
          {
            key: "webhook_url",
            label: t("config.integrations.rocketchatWebhookUrl"),
            type: "url",
          },
          {
            key: "channel",
            label: t("config.integrations.rocketchatChannel"),
            type: "text",
          },
          {
            key: "alias",
            label: t("config.integrations.rocketchatAlias"),
            type: "text",
          },
          {
            key: "avatar",
            label: t("config.integrations.rocketchatAvatar"),
            type: "text",
          },
        ];
      default:
    ...
    >
                  ...
                  <CardContent className="space-y-4">
                    {integration.last_sync_at && (
                      <p className="text-sm text-muted-foreground">
                        {t("config.integrations.lastSync")}:{" "}
                      ...
                      <Button
                        ...
                        disabled={
                          (activateMutation.isPending &&
                            activateMutation.variables?.integrationId ===
                              integration.id) ||
                          (deactivateMutation.isPending &&
                            deactivateMutation.variables === integration.id)
                        }
                      >
      ...
      <Dialog open={configDialogOpen} onOpenChange={setConfigDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              {t("config.integrations.configDialogTitle")}{" "}
              {selectedIntegration?.name}
            </DialogTitle>
            <DialogDescription>
              {selectedIntegration
                ? availableIntegrations.find(
                    (i) => i.id === selectedIntegration.type
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t("config.integrations.deleteConfirmTitle")}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {integrationToDelete
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() =>
                integrationToDelete &&
                deleteMutation.mutate(integrationToDelete.id)
              }
