...
down_revision: str | None = "57d4493a7380"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_categories_tenant_id", "categories", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        "idx_products_tenant_name", "products", ["tenant_id", "name"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "product_id", "sku", name="uq_product_variants_product_sku"
        ),
    )
    op.create_index(
    ...
    op.create_index(
        "ix_product_variants_sku", "product_variants", ["sku"], unique=False
    )
    ...
    op.create_index(
        "ix_product_barcodes_tenant_id", "product_barcodes", ["tenant_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_product_barcodes_variant_id",
        "product_barcodes",
        ["variant_id"],
        unique=False,
    )
    op.create_index(
        "ix_product_barcodes_barcode", "product_barcodes", ["barcode"], unique=True
    )
