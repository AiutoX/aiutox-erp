...
try:
    from app.core.reporting.sources.products_data_source import (
        ProductsDataSource as _ProductsDataSource,
    )

    _products_ds_available = True
except ImportError:
    _ProductsDataSource = None  # type: ignore[assignment,misc]
    _products_ds_available = False
...
def get_reporting_service(
    ...
    if _products_ds_available:
        service.engine.register_data_source("products", _ProductsDataSource)
    return service
