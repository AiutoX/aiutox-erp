...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_warehouses_tenant_id", "warehouses", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        "ix_locations_warehouse_id", "locations", ["warehouse_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["from_location_id"], ["locations.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["to_location_id"], ["locations.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        "ix_stock_moves_tenant_id", "stock_moves", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_stock_moves_product_id", "stock_moves", ["product_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_stock_moves_move_type", "stock_moves", ["move_type"], unique=False
    )
    op.create_index(
