    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          <Label htmlFor="activity_type">{t("activities.types.title")}</Label>
          <Select
        ...
        <div className="space-y-2">
          <Label htmlFor="title">{t("activities.titleLabel")}</Label>
          <Input
            id="title"
      ...
      <div className="space-y-2">
        <Label htmlFor="description">{t("activities.descriptionLabel")}</Label>
        <Textarea
          id="description"
      ...
      <div className="space-y-4">
        <h4 className="text-sm font-medium">{t("activities.metadataLabel")}</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={t("activities.metadata.assignedToPlaceholder")}
            />
          </div>
        </div>
      </div>
