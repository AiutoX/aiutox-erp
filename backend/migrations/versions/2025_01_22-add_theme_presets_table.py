...
down_revision: str | None = "2025_12_21_config_versions"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_theme_presets_tenant_id", "theme_presets", ["tenant_id"], unique=False
    )

    # Composite indexes
    op.create_index(
        "idx_theme_presets_system", "theme_presets", ["is_system", "name"], unique=False
    )
    op.create_index(
        "idx_theme_presets_tenant",
        "theme_presets",
