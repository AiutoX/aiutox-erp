...
down_revision: str | None = "add_templates_tables"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_comments_entity_type", "comments", ["entity_type"], unique=False
    )
    ...
    op.create_index(
        "idx_comments_entity", "comments", ["entity_type", "entity_id"], unique=False
    )
    op.create_index(
        "idx_comments_tenant_entity",
        "comments",
        ["tenant_id", "entity_type", "entity_id"],
        unique=False,
    )
    op.create_index(
        "idx_comments_parent", "comments", ["parent_id", "created_at"], unique=False
    )
    ...
    op.create_index(
        "ix_comment_mentions_tenant_id", "comment_mentions", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_comment_mentions_comment_id",
        "comment_mentions",
        ["comment_id"],
        unique=False,
    )
    ...
    op.create_index(
        ...
        "comment_mentions",
        ["mentioned_user_id", "notification_sent"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_comment_attachments_tenant_id",
        "comment_attachments",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_comment_attachments_file_id",
        "comment_attachments",
        ["file_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_comment_mentions_mentioned_user_id", table_name="comment_mentions"
    )
