...
down_revision: str | None = "add_task_source_fields"
...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index(
        "ix_task_assignments_task_id", "task_assignments", ["task_id"], unique=False
    )
    op.create_index(
        "ix_task_assignments_tenant_id", "task_assignments", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_task_assignments_assigned_to_id",
        "task_assignments",
        ["assigned_to_id"],
        unique=False,
    )
    op.create_index(
        "ix_task_assignments_assigned_at",
        "task_assignments",
        ["assigned_at"],
        unique=False,
    )
