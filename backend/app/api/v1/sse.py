...
async def sse_notifications(
    request: Request,
    current_user: Annotated[User | None, Depends(get_current_user)] = None,  # type: ignore[assignment]
    db: Annotated[Session | None, Depends(get_db)] = None,  # type: ignore[assignment]
):
