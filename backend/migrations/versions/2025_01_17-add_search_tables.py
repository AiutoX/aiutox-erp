...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_search_indices_tenant_id", "search_indices", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_search_indices_entity_type", "search_indices", ["entity_type"], unique=False
    )
    op.create_index(
        "ix_search_indices_entity_id", "search_indices", ["entity_id"], unique=False
    )
    op.create_index(
        "ix_search_indices_created_at", "search_indices", ["created_at"], unique=False
    )
    op.create_index(
        "idx_search_indices_entity",
        "search_indices",
        ["entity_type", "entity_id"],
        unique=True,
    )
    op.create_index(
        "idx_search_indices_tenant_entity",
        "search_indices",
