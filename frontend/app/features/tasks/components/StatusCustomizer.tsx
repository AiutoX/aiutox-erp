...
import { translateStatusLabel } from "~/features/tasks/utils/statuses";
...
export function StatusCustomizer() {
  ...
  const [editingStatus, setEditingStatus] =
    useState<TaskStatusDefinition | null>(null);
    ...
    try {
      ...
      const msg =
        error && typeof error === "object" && "response" in error
          ...
          : "";
      showToast(
        msg || "Error al eliminar estado. Puede estar en uso por tareas.",
        "error"
      );
    }
  };
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-medium">
                        {translateStatusLabel(t, status.name)}
                      </span>
                      {status.is_system && (
