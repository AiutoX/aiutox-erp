...
def upgrade() -> None:
    ...
    op.create_index(
        ...
        "user_preferences",
        ["user_id", "preference_type", "key"],
        unique=True,
    )
    op.create_index(
        "idx_user_preferences_tenant", "user_preferences", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        "ix_org_preferences_tenant_id", "org_preferences", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_org_preferences_preference_type",
        "org_preferences",
        ["preference_type"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_role_preferences_role_id", "role_preferences", ["role_id"], unique=False
    )
    op.create_index(
        "ix_role_preferences_tenant_id", "role_preferences", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_role_preferences_preference_type",
        "role_preferences",
        ["preference_type"],
        unique=False,
    )
    op.create_index(
        ...
        "role_preferences",
        ["role_id", "preference_type", "key"],
        unique=True,
    )
    op.create_index(
        "idx_role_preferences_tenant", "role_preferences", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        "ix_saved_views_tenant_id", "saved_views", ["tenant_id"], unique=False
    )
    op.create_index("ix_saved_views_module", "saved_views", ["module"], unique=False)
    op.create_index(
        "idx_saved_views_user_module",
        "saved_views",
        ["user_id", "module"],
        unique=False,
    )
    op.create_index(
        "idx_saved_views_tenant", "saved_views", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        "ix_dashboards_tenant_id", "dashboards", ["tenant_id"], unique=False
    )
