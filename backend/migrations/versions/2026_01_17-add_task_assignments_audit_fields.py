...
def upgrade() -> None:
    ...
    if "ix_task_assignments_created_by_id" not in inspector.get_indexes(
        "task_assignments"
    ):
        op.create_index(
    ...
    if "fk_task_assignments_created_by_id" not in [
        fk["name"] for fk in inspector.get_foreign_keys("task_assignments")
    ]:
    ...
    if "ix_task_assignments_updated_by_id" not in inspector.get_indexes(
        "task_assignments"
    ):
        op.create_index(
    ...
    if "fk_task_assignments_updated_by_id" not in [
        fk["name"] for fk in inspector.get_foreign_keys("task_assignments")
    ]:
        op.create_foreign_key(
