...
down_revision: str | None = "add_import_export_tables"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_saved_filters_tenant_id", "saved_filters", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_saved_filters_module", "saved_filters", ["module"], unique=False
    )
    op.create_index(
        "ix_saved_filters_created_by", "saved_filters", ["created_by"], unique=False
    )
    op.create_index(
        "idx_saved_filters_tenant_module",
        "saved_filters",
        ["tenant_id", "module"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_custom_views_tenant_id", "custom_views", ["tenant_id"], unique=False
    )
    op.create_index("ix_custom_views_module", "custom_views", ["module"], unique=False)
    op.create_index(
        "ix_custom_views_created_by", "custom_views", ["created_by"], unique=False
    )
    op.create_index(
        "idx_custom_views_tenant_module",
        "custom_views",
        ["tenant_id", "module"],
        unique=False,
    )
    op.create_index(
        "idx_custom_views_user",
        "custom_views",
        ["tenant_id", "created_by"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_view_shares_tenant_id", "view_shares", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_view_shares_filter_id", "view_shares", ["filter_id"], unique=False
    )
    op.create_index("ix_view_shares_view_id", "view_shares", ["view_id"], unique=False)
    op.create_index(
        "ix_view_shares_shared_with_user_id",
        "view_shares",
        ["shared_with_user_id"],
        unique=False,
    )
    op.create_index(
        "idx_view_shares_filter",
        "view_shares",
        ["tenant_id", "filter_id"],
        unique=False,
    )
    op.create_index(
        "idx_view_shares_view", "view_shares", ["tenant_id", "view_id"], unique=False
    )
    op.create_index(
        "idx_view_shares_user",
        "view_shares",
