...
down_revision: str | None = "add_views_tables"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_approval_flows_tenant_id", "approval_flows", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_approval_flows_module", "approval_flows", ["module"], unique=False
    )
    op.create_index(
        "ix_approval_flows_created_by", "approval_flows", ["created_by"], unique=False
    )
    op.create_index(
        "idx_approval_flows_tenant_module",
        "approval_flows",
        ["tenant_id", "module"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "approver_rule", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        "ix_approval_steps_tenant_id", "approval_steps", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_approval_steps_flow_id", "approval_steps", ["flow_id"], unique=False
    )
    op.create_index(
        "idx_approval_steps_flow_order",
        "approval_steps",
        ["flow_id", "step_order"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_approval_requests_flow_id", "approval_requests", ["flow_id"], unique=False
    )
    op.create_index(
        "ix_approval_requests_entity_type",
        "approval_requests",
        ["entity_type"],
        unique=False,
    )
    op.create_index(
        "ix_approval_requests_entity_id",
        "approval_requests",
        ["entity_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_approval_actions_tenant_id", "approval_actions", ["tenant_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_approval_actions_acted_by", "approval_actions", ["acted_by"], unique=False
    )
    op.create_index(
        "ix_approval_actions_acted_at", "approval_actions", ["acted_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_approval_delegations_tenant_id",
        "approval_delegations",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        "ix_approval_delegations_request_id",
        "approval_delegations",
        ["request_id"],
        unique=False,
    )
    op.create_index(
        "ix_approval_delegations_from_user_id",
        "approval_delegations",
        ["from_user_id"],
        unique=False,
    )
    op.create_index(
        "ix_approval_delegations_to_user_id",
        "approval_delegations",
        ["to_user_id"],
        unique=False,
    )
    op.create_index(
        "ix_approval_delegations_is_active",
        "approval_delegations",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        "idx_approval_delegations_active",
        "approval_delegations",
        ["tenant_id", "is_active"],
        unique=False,
    )
    op.create_index(
        "idx_approval_delegations_from",
        "approval_delegations",
        ["from_user_id", "is_active"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_approval_delegations_is_active", table_name="approval_delegations"
    )
    op.drop_index(
        "ix_approval_delegations_to_user_id", table_name="approval_delegations"
    )
    op.drop_index(
        "ix_approval_delegations_from_user_id", table_name="approval_delegations"
    )
    op.drop_index(
        "ix_approval_delegations_request_id", table_name="approval_delegations"
    )
    op.drop_index(
        "ix_approval_delegations_tenant_id", table_name="approval_delegations"
    )
