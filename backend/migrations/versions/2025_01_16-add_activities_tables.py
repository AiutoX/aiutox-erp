...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_activities_tenant_id", "activities", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_activities_entity_type", "activities", ["entity_type"], unique=False
    )
    op.create_index(
        "ix_activities_entity_id", "activities", ["entity_id"], unique=False
    )
    op.create_index(
