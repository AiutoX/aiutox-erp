...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_import_jobs_tenant_id", "import_jobs", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        "ix_import_jobs_created_by", "import_jobs", ["created_by"], unique=False
    )
    op.create_index(
        "ix_import_jobs_created_at", "import_jobs", ["created_at"], unique=False
    )
    op.create_index(
        "idx_import_jobs_tenant_status",
        "import_jobs",
        ["tenant_id", "status"],
        unique=False,
    )
    op.create_index(
        "idx_import_jobs_module", "import_jobs", ["tenant_id", "module"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "default_values", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "validation_rules", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "transformations", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.Column(
            "encoding", sa.String(length=20), nullable=False, server_default="utf-8"
        ),
        sa.Column("created_by", postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        "ix_import_templates_tenant_id", "import_templates", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_import_templates_module", "import_templates", ["module"], unique=False
    )
    op.create_index(
        "ix_import_templates_created_by",
        "import_templates",
        ["created_by"],
        unique=False,
    )
    op.create_index(
        "idx_import_templates_tenant_module",
        "import_templates",
        ["tenant_id", "module"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_export_jobs_tenant_id", "export_jobs", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        "ix_export_jobs_created_by", "export_jobs", ["created_by"], unique=False
    )
    op.create_index(
        "ix_export_jobs_created_at", "export_jobs", ["created_at"], unique=False
    )
    op.create_index(
        "idx_export_jobs_tenant_status",
        "export_jobs",
        ["tenant_id", "status"],
        unique=False,
    )
    op.create_index(
        "idx_export_jobs_module", "export_jobs", ["tenant_id", "module"], unique=False
    )
