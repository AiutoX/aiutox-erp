...
export const searchTranslations = {
  ...
  // Entity type labels — keyed by the raw entity_type string returned by
  // GET /search/searchable-types (SearchIndexDefinition.entity_type on each
  // module's SearchProvider), used to translate result-type tabs/badges
  // instead of showing the raw identifier (e.g. "task", "calendar_event").
  entityTypes: {
    task: "Tarea",
  ...
  search: {
    ...
    tryDifferent:
      "Intenta con palabras clave diferentes o elimina filtros de búsqueda",
  ...
  error: {
    title: "Error",
    fetchFailed:
      "Error al obtener resultados de búsqueda. Por favor, inténtalo de nuevo.",
