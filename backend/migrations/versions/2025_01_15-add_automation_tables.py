...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_rules_tenant_enabled", "rules", ["tenant_id", "enabled"], unique=False
    )
    ...
    op.create_index(
        "ix_rule_versions_rule_id", "rule_versions", ["rule_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_automation_executions_rule_status",
        "automation_executions",
        ["rule_id", "status"],
        unique=False,
    )
...
def downgrade() -> None:
    # Drop indexes
    op.drop_index(
        "idx_automation_executions_executed_at", table_name="automation_executions"
    )
    op.drop_index(
        "idx_automation_executions_rule_status", table_name="automation_executions"
    )
    op.drop_index("ix_automation_executions_status", table_name="automation_executions")
    op.drop_index(
        "ix_automation_executions_event_id", table_name="automation_executions"
    )
    op.drop_index(
        "ix_automation_executions_rule_id", table_name="automation_executions"
    )
