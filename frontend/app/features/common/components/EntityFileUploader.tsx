...
export function EntityFileUploader({
  ...
  const handleUpload = useCallback(async () => {
    ...
    try {
      // Upload file using apiClient (includes JWT auth via interceptor)
      ...
      // Las tareas requieren un paso de adjunto separado; los eventos de
      // calendario ya quedan adjuntos con el upload (entity_type/entity_id).
      if (entityType === "task") {
  ...
  }, [selectedFile, entityId, entityType, attachTaskMutation, onUploadComplete, t]);
      ...
      <CardContent className="p-4">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="text-sm font-medium">{t("files.dragDrop")}</h3>
