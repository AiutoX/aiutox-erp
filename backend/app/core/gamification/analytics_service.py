...
from app.core.gamification.models import GamificationEvent, UserPoints
...
class AnalyticsService:
    ...
    def get_team_analytics(
        self, user_ids: list[UUID], user_names: dict[UUID, str] | None = None
    ) -> dict[str, Any]:
        """Get aggregated team analytics.

        Args:
            user_ids: List of team member user IDs
            user_names: Optional map of user_id -> display name
        ...
        top_performers = [
            {
                ...
                "user_name": user_names.get(cast(UUID, up.user_id), ""),
                ...
                alerts.append(
                    {
                        ...
                        "employee_name": user_names.get(cast(UUID, up.user_id), ""),
                        "severity": "medium",
                        "recommendation_key": "burnoutRisk",
                        "data": {
                            "streak": up.current_streak,
                            "points": up.total_points,
                        },
                    ...
                    alerts.append(
                        {
                            ...
                            "employee_name": user_names.get(cast(UUID, up.user_id), ""),
                            "severity": severity,
                            "recommendation_key": "disengagement",
                            "data": {
