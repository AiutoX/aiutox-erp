...
down_revision: str | None = "add_files_tables"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "transitions", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "created_at",
            postgresql.TIMESTAMP(timezone=True),
    ...
    op.create_index(
        "ix_workflow_steps_tenant_id", "workflow_steps", ["tenant_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "execution_data", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["current_step_id"], ["workflow_steps.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        "ix_workflow_executions_entity_type",
        "workflow_executions",
        ["entity_type"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_workflow_executions_entity",
        "workflow_executions",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["workflow_step_id"], ["workflow_steps.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        "ix_tasks_related_entity_type", "tasks", ["related_entity_type"], unique=False
    )
    op.create_index(
        "ix_tasks_related_entity_id", "tasks", ["related_entity_id"], unique=False
    )
    ...
    op.create_index(
        "idx_tasks_tenant_status", "tasks", ["tenant_id", "status"], unique=False
    )
    op.create_index(
        "idx_tasks_tenant_priority", "tasks", ["tenant_id", "priority"], unique=False
    )
    op.create_index(
        "idx_tasks_assigned", "tasks", ["tenant_id", "assigned_to_id"], unique=False
    )
    op.create_index(
        "idx_tasks_due_date", "tasks", ["tenant_id", "due_date"], unique=False
    )
    op.create_index(
        "idx_tasks_entity",
        "tasks",
    ...
    op.create_index(
        "ix_task_checklist_items_tenant_id",
        "task_checklist_items",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        "ix_task_checklist_items_completed",
        "task_checklist_items",
        ["completed"],
        unique=False,
    )
    op.create_index(
        "idx_task_checklist_task",
        "task_checklist_items",
        ["task_id", "order"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_workflow_executions_entity_type", table_name="workflow_executions"
    )
    ...
    op.drop_index(
        "ix_task_checklist_items_completed", table_name="task_checklist_items"
    )
    op.drop_index(
        "ix_task_checklist_items_tenant_id", table_name="task_checklist_items"
    )
